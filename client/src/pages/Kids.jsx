        ...
        <div style={{ backgroundColor: 'white', }}>
            <div style={{ width: '100%', padding: '2rem 6rem 1rem',  backgroundColor: 'rgba(132, 152, 176, 0.5)', margin: '16px 0px'}}> 
                <Breadcrumb style={{ marginBottom: '16px' }}>
                    ...
                    <Breadcrumb.Item><Link to="/kids">Kids</Link> </Breadcrumb.Item>
                </Breadcrumb>
                <h1 className="text-xxl font-semibold" style={{ margin: '16px 0', color: "rgb(71, 89, 122)" }}>Kids</h1> 
            </div>
                ...
                <Row gutter={[16,16]}>
                    ...
                    (subcategories?.map((sub) => (
                        ...
                        >
                            ...
                            <Link to={`/kids/${sub}`}>View {sub}</Link>
                        </Card>
                    )))}
                </Row>     
            </div>
